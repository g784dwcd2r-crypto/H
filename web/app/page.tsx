    ...
    <>
      <section className="landing-hero" aria-labelledby="landing-title">
        <div className="landing-copy">
          <h1 id="landing-title">The filings.<br />The financials.<br />Ready for your<br className="headline-break" /> analysis.</h1>
      ...
      <section className="feature-triptych" id="how-it-works" aria-label="How Disclosure works">
        <article><p className="eyebrow">01 / Discover</p><h2>One period. Related filings.</h2><div className="feature-docs"><span>FY 2024</span><div><a href={EXAMPLE_ANNUAL} target="_blank" rel="noreferrer"><DocumentIcon />Annual report</a><a href={EXAMPLE_RELEASE} target="_blank" rel="noreferrer"><DocumentIcon />Earnings release</a></div></div></article>
        <article><p className="eyebrow">02 / Understand</p><h2>A number. Its evidence.</h2><a className="feature-evidence" href={EXAMPLE_SOURCE} target="_blank" rel="noreferrer"><span>Total net sales<strong>391,035</strong></span><small>FY 2024 · USD millions · Source document ↗</small></a></article>
        <article><p className="eyebrow">03 / Export</p><h2>Your periods. Excel-ready.</h2><div className="feature-sheet"><div><DocumentIcon />AAPL_financials.xlsx <span>Example</span></div><table><thead><tr><th>Metric</th><th>FY 2024</th><th>FY 2023</th></tr></thead><tbody><tr><td>Total net sales</td><td>391,035</td><td>383,285</td></tr></tbody></table></div></article>
      </section>
